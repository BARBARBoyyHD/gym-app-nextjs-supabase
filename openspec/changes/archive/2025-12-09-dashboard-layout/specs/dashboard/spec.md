...
The system MUST integrate the dashboard into the existing navigation structure.

#### Scenario: Dashboard navigation
- **WHEN** an authenticated admin user accesses the navigation menu
- **THEN** the dashboard is accessible through the admin navigation
- **AND** clicking the dashboard link navigates to the dashboard page
- **AND** the navigation maintains the user's current session