        ...
        <div className=" grid grid-cols-1 md:grid-cols-5 gap-10 place-items-center">
          <div className="md:col-span-3">
            ...
            <p className="text-lg text-white/70 leading-7">
              ...
              fugit ullam excepturi sed perspiciatis aliquam deleniti voluptate!
              Tempora deleniti quibusdam sapiente voluptatum. Ad culpa veritatis
              minima aperiam atque, quod ratione doloremque.
            </p>
          </div>
